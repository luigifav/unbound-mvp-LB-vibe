...
export default function Home() {
  return (
    <main className="bg-[#000904] min-h-[calc(100vh-64px)] relative overflow-x-hidden">
      ...
      <div className="absolute top-[-250px] left-1/2 -translate-x-1/2 w-[900px] h-[650px] bg-[radial-gradient(ellipse,rgba(124,34,213,0.18)_0%,transparent_70%)] pointer-events-none" />
